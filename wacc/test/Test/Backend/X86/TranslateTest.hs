...
runTranslationTest
  :: Prog -> TACProgram Integer Integer -> (Prog -> Prog -> Bool) -> Bool
...
instance WeakEq Operand where
  wEq (Imm i1) (Imm i2) = i1 == i2
  wEq (Imm _) _ = False
  wEq _ (Imm _) = False
  wEq _ _ = True

instance WeakEq Instr where
  ...
  wEq (BinOp name1 size1 op1 op2) (BinOp name2 size2 op3 op4) = name1 == name2 && size1 == size2 && op1 `wEq` op3 && op2 `wEq` op4
  wEq x y = x == y
