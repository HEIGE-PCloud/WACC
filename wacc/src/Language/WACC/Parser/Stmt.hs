...
import Text.Gigaparsec.Errors.Patterns (verifiedExplain, preventativeExplain)
...
_semiColonAfterEnd = preventativeExplain (const "semi-colons cannot follow the `end` of the program") ";"
